...
export default class MyHttp {
    ...
    static addTicketToList(evt) {
        ...
        xhr.open('POST', 'https://rbks.bmnet.org:7070?method=createTicket');
    ...
    static showDeleteTicket(evt) {
        ...
        delTicket.querySelector('.delticket-delete-button').onclick = (event) => {
            ...
            xhr.open('DELETE', `https://rbks.bmnet.org:7070?method=deleteTicket&id=${evt.target.parentElement.dataset.id}`);
            xhr.send();
    ...
    static showDetailTicket(evt) {
        ...
        xhr.open('GET', `https://rbks.bmnet.org:7070?method=ticketById&id=${parent.dataset.id}`);
        xhr.send();
    ...
    static loadTickets() {
        ...
        xhr.open('GET', 'https://rbks.bmnet.org:7070?method=allTickets');
        //xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    ...
    static setStatusTicket(evt) {
        ...
        xhr.open('POST', 'https://rbks.bmnet.org:7070?method=setStatus');
        xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
    ...
    static showEditTicket(evt) {
        ...
        xhr.open('GET', `https://rbks.bmnet.org:7070?method=ticketById&id=${evt.target.parentElement.dataset.id}`);
        xhr.send();
        ...
        editTicket.querySelector('.editticket-edit-button').onclick = (event) => {
            ...
            xhr.open('PATCH', 'https://rbks.bmnet.org:7070?method=editTicket');
            xhr.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
